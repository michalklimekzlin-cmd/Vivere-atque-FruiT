export async function mountMentorBadges(url = "members.json"){
  ...
  css.textContent = `
    .mentor-badge{
      position:fixed;z-index:21;background:rgba(20,24,32,.88);color:#cfe;
    ...
    .mb-tl{top:52px;left:16px}      /* pod tlačítkem #btnTopLeft */
    .mb-tr{top:52px;right:16px}     /* pod tlačítkem #btnTopRight */
    .mb-bl{bottom:52px;left:16px}   /* nad tlačítkem #btnBottomLeft */
    .mb-br{bottom:52px;right:16px}  /* nad tlačítkem #btnBottomRight */
  `;
