...
const REQUIRED_FILES = [
  ...
  { label: "most Glyphů do Paměti", url: "./js/cht-glyph-bridge.js" },
  { label: "společná síť CHT", url: "./js/cht-360-network.js" },
  { label: "dílna Glyph CHT", url: "./glyph-cht-360/index.html" },
  { label: "skript dílny Glyph", url: "./glyph-cht-360/app.js" },
  { label: "styl dílny Glyph", url: "./glyph-cht-360/styles.css" },
  { label: "offline vrstva dílny Glyph", url: "./glyph-cht-360/sw.js" },
  { label: "Mluva CHT", url: "./mluva-cht-360/index.html" },
  { label: "skript Mluvy CHT", url: "./mluva-cht-360/app.js" },
  { label: "styl Mluvy CHT", url: "./mluva-cht-360/styles.css" },
  { label: "offline vrstva Mluvy CHT", url: "./mluva-cht-360/sw.js" },
  { label: "zámkové Bubínky", url: "./bubinky/index.html" },
  { label: "zámky Bubínků", url: "./bubinky/slot-locks.js" },
  { label: "skript zámkových Bubínků", url: "./bubinky/app.js" },
...
const STORAGE_CHECKS = [
  ...
  { key: "vaft_pamet_v1", label: "záložní Paměť", required: false },
